  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setShiftDetails('');
        setSalaryDetails('');
        // Navigate to lab technicians page
        navigate('/staff-management/lab');
      } else {
