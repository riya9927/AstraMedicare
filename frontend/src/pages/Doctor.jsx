      ...
      <div className='flex flex-col sm:flex-row items-start gap-6 mt-7'>
        <div className="bg-white shadow-lg rounded-lg p-5 text-gray-700 w-full sm:w-1/4">
          ...
          <div className="space-y-3">
            ...
            <p onClick={() => speciality === 'Gastroenterologist' ? navigate('/doctors') : navigate('/doctors/Gastroenterologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality==="Gastroenterologistz" ? "bg-[#185fad] text-white shadow-md" : "bg-gray-100 hover:bg-[#185fad] hover:text-white"}`}>Gastroenterologist</p>
          </div>
        </div>
