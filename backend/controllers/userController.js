    ...
    try {
        ...
        if (bloodGroup) {
            ...
            if (validBloodGroups.includes(bloodGroup)) {
                ...
                return res.json({ success: false, message: "Invalid blood group" });
            }
        }
        ...
        if (emergencyContact) {
            try {
                const contactObj = typeof emergencyContact === 'string' ?
                    JSON.parse(emergencyContact) : emergencyContact;

                updateData.emergencyContact = {
                    name: contactObj.name || "",
                    relation: contactObj.relation || "",
        ...
        if (imageFile) {
            try {
                ...
                // The profile was updated but image upload failed
                return res.json({
                    success: true,
